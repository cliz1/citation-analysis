...
**Usage:** add target paper titles (one per line) to `papers_list.txt`, set `ZOTERO_STORAGE` to your Zotero storage path. Then run the script - currently, it just prints the data by title to stdout. 
